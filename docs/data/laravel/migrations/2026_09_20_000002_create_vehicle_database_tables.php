...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('vehicle_makes', function (Blueprint $table) {
            ...
            $table->string('source', 50)->default('nhtsa'); // 'nhtsa', 'manual', 'other'
        ...
        Schema::create('vehicle_aliases', function (Blueprint $table) {
            $table->id();
            $table->string('entity_type', 50); // 'make', 'model'
        ...
        // 7. product_vehicle_compatibilities
        ...
        Schema::create('vehicle_sync_logs', function (Blueprint $table) {
            $table->id();
            $table->string('type', 50)->index(); // 'makes', 'models', 'years', 'specs', 'vin_decode'
            $table->string('status', 50)->index(); // 'RUNNING', 'SUCCESS', 'FAILED', 'PARTIAL'
