...
class VehicleDatabaseSeeder extends Seeder
{
    ...
    {
        // Clean existing tables to allow idempotent re-runs
        DB::table('user_vehicles')->delete();
        DB::table('product_vehicle_compatibilities')->delete();
        DB::table('vehicle_sync_logs')->delete();
        DB::table('vehicle_specs')->delete();
        DB::table('vehicle_model_years')->delete();
        DB::table('vehicle_aliases')->delete();
